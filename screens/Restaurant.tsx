...
import { IRestaurantData, InitialCurrentLocationProps } from './Home'
...
export const Restaurant = ({ route, navigation }: Iprops): JSX.Element => {
  ...
  const editOrder = ({ action, menuId, price }: IOrder) => {
        ...
        {restaurant?.menu.map((item, index) => (
          <View key={`menu-${index}`} style={{ alignItems: 'center' }}>
            <View style={{ height: SIZES.height * 0.35 }}>
              ...
              >
                <TouchableOpacity
                  ...
                  onPress={() => editOrder({ action: "-", menuId: item.menuId, price: item.price })}
                >
            ...
            <View style={{
              ...
              <Text style={{ marginVertical: 10, textAlign: 'center', ...FONTS.h3, fontWeight: 'bold' }}>
        ...
        >
          ...
          <View style={{
            ...
            <View style={{ flexDirection: 'row' }}>
              ...
              />
              <Text style={{ marginLeft: SIZES.padding, ...FONTS.h4 }}>12345</Text>
            </View>
          </View>
          {/* Order Button */}
          <View style={{ padding: SIZES.padding * 2, alignItems: 'center', justifyContent: 'center' }}>
            ...
            >
              <Text style={{ color: COLORS.white, ...FONTS.h2, fontWeight: 'bold' }}>Order</Text>
            </TouchableOpacity>
          </View>
        </View>
        {isIphoneX() &&
          <View
            style={{
              position: 'absolute', bottom: -34, left: 0, right: 0, height: 34, backgroundColor: COLORS.white
            }}>
          </View>
        }
      </View>
